h1. (1) Installing Android Studio (Linux)

{{toc}}

h2. Background: 

Until now, we have been using Ant as the build tool to compile Android-Studio (hereafter referred to as simply *AS*). However, due to the decreasing popularity of Ant and much smaller user base combined with reduced up-to-date instructions, we have "migrated":https://developer.android.com/studio/intro/migrate.html to use the standard Gradle build tools. This is what is and has been used by most Android app developers since the beginning of the Android revolution. Today, the Gradle build tool is integrated in Android-Studio, even if other tools are supported as well. Gradle is a script based task handler and can be a little tricky to get to work as it doesn't necessarily follow standard scripting logic. Below we present how to get AS up and running on a standard Linux distribution.

What is "Android-Studio":https://developer.android.com/studio/intro/index.html ? 
> Android Studio is the official Integrated Development Environment (IDE) for Android app development, based on IntelliJ IDEA.

h2. OS and hardware setup 

These instructions were made and verified to work with "Linux Mint":https://linuxmint.com/ *18* _Sarah_ (LTS) [Cinnamon/x64].
...
h2. Package Dependencies and Requirements
...
The "installation instructions":https://developer.android.com/studio/install.html for AS are as follows:
...
h2. Create and setup the installation paths and directories
...
h2. Download and Install all the Android packages

Go to the following web pages and download each into: _/opt/android/_
<pre>
...
h2. Check your Java installation (OpenJDK should already be installed.)
...
h2. Soft-link some binaries for easy access.
...
Accept all licenses!
OR read:
# [1] https://developer.android.com/studio/intro/update.html
# [2] https://developer.android.com/studio/releases/build-tools.html
# [3] https://developer.android.com/studio/build/building-cmdline.html
...
(You want to redirect _stderr_ to /dev/null to rid the screen from annoying GLib errors.)
...
| package_name | version | API | 
| WIP | WIP2 | 19 |

h2. Additional AS tweaks
